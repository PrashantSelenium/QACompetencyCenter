		...
		for (int row=0; row<numberOfRows ; row++) {
			...
			for(int col=0; col<numberOfCols;col++){
				...
				if((pageHeightLeft < pageheight) && (pageWidthLeft < pageWidth )){
					...
					ImageIO.write(subImage, "jpg", new File("D:\\Github\\QACompetencyCenter\\AppiumAndroidTest\\snapshots\\screenshot"+row+"_"+col+"_1.jpg"));
					...
					ImageIO.write(subImage, "jpg", new File("D:\\Github\\QACompetencyCenter\\AppiumAndroidTest\\snapshots\\screenshot"+row+"_"+col+".jpg"));
					rowArr.set(rowArr.size()-1, subImage);
...
//			js.executeScript("window.scrollBy(0,"+pageheight+")");
	...
	private void takeScreenshot(WebDriver driver, int row, int col) {
		...
		try {
			...
			ImageIO.write(image, "jpg", new File("D:\\Github\\QACompetencyCenter\\AppiumAndroidTest\\snapshots\\screenshot"+row+"_"+col+".jpg"));
